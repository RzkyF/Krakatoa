            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <h3>Edit menu <a href="<?= site_url('/menu'); ?>"></a></h3> 
                    <hr>
                    <nav aria-label="breadcrumb">
                     ...
                     <div class="card-body"> 
                    <form method="POST" class="formmenu" action="<?= site_url('menu/update/'.$menu->id_menu) ?>" onsubmit="return checkForm(this);" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= (old('nama_menu')) ? old('nama_menu') : $menu->nama_menu ; ?>" class="form-control <?= ($validation->hasError('nama_menu')) ? 'is-invalid' : ''; ?>" placeholder="Nama Menu..." name="nama_menu" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <option disabled value="">-: Pilih Jenis Menu :-</option>
                                    <option selected value="<?= (old('jenis')) ? old('jenis') : $menu->jenis ; ?>"><?= $menu->jenis ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= (old('harga')) ? old('harga') : $menu->harga ; ?>" class="form-control <?= ($validation->hasError('harga')) ? 'is-invalid' : ''; ?>" name="harga" autocomplete="off">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <option disabled value="">-: Pilih Status Menu :-</option>
                                                <option value="tersedia" <?= ($menu->status_masakan == 'tersedia') ? 'selected' : ''; ?>>Tersedia</option>
                                                <option value="habis" <?= ($menu->status_masakan == 'habis') ? 'selected' : ''; ?>>Habis</option>
                                    </select>
                                    <div class="invalid-feedback">
